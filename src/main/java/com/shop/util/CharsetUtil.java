 ...
 * @author liquor
 * @date 2017年12月28日 下午3:40:23 
 *
 */
public final class CharsetUtil {
    /**
     * @Description: 7位ASCII字符，也叫作ISO646-US、Unicode字符集的基本拉丁块
     */
    public static final String US_ASCII = "US-ASCII";

    /**
     * @Description: ISO 拉丁字母表 No.1，也叫作 ISO-LATIN-1
     */
    public static final String ISO_8859_1 = "ISO-8859-1";

    /**
     * @Description: 8 位 UCS 转换格式
     */
    public static final String UTF_8 = "UTF-8";

    /**
     * @Description: 16 位 UCS 转换格式，Big Endian（最低地址存放高位字节）字节顺序
     */
    public static final String UTF_16BE = "UTF-16BE";

    /**
     * @Description: 16 位 UCS 转换格式，Little-endian（最高地址存放低位字节）字节顺序
     */
    public static final String UTF_16LE = "UTF-16LE";

    /**
     * @Description: 16 位 UCS 转换格式，字节顺序由可选的字节顺序标记来标识
     */
